...
#ifndef VIE_Macros_Web_Api_h
#define VIE_Macros_Web_Api_h

#ifdef DEBUG
    #if 1
        //内网测试IP:
        #define VIE_NetWork_Web_Api @"http://192.168.10.206:8080/m_pharmacy"
    #else
        //本地IP：
        #define VIE_NetWork_Web_Api @"http://192.168.20.54:7070/m_pharmacy"
    #endif
#else
    #define IHF_NetWork_Web_Api [NSString stringWithFormat:@"%@/m_pharmacy/", [[NSUserDefaults standardUserDefaults] objectForKey:@"MedicineServerIP"]]
#endif
