...
#import "VIEPopAnimationView.h"


@interface VIEPopAnimationView()
...
//弹出的 样式
@property (nonatomic, strong) VIEPopStyle *popStyle;
...
@implementation VIEPopAnimationView
...
+ (id)popAnimationView:(UIView*)view popStyle:(VIEPopStyle*)popStyle
{
    VIEPopAnimationView *popView = [[VIEPopAnimationView alloc] initAnimationView:view popStyle:popStyle];
    [popView present];
    return popView;
}

- (id)initAnimationView:(UIView*)view popStyle:(VIEPopStyle*)popStyle
{
    self = [super init];
    if (self)
    {
        ...
        if (popStyle) {
            ...
            self.popStyle = [[VIEPopStyle alloc] init];
        }
